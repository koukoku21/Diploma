...
class _VisibilityBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.visibility_rounded, color: Color(0xFF4CAF50), size: 20),
          const SizedBox(width: AppSpacing.sm),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Видны клиентам', style: AppTextStyles.body.copyWith(color: const Color(0xFF4CAF50))),
                Text('Приложение бесплатно на период запуска', style: AppTextStyles.caption.copyWith(color: kTextSecondary)),
              ],
            ),
          ),
        ],
